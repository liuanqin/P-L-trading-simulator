...
public class BuyStock extends TradeStock {
	// constructor for buying stock
	public BuyStock(String milliSeconds,String symbolName, double fillPrice, double fillSize,HashMap<String,double[]> pnl) {
	...
	public void updatePNL() {
		if(pnl.containsKey(symbolName)){
			...
			stockInfo[0] = fillSize;  //size of stock
			stockInfo[1] = fillPrice; // current prize
			stockInfo[2] = -fillPrice*fillSize; // total money spent
